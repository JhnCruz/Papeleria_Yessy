...
// Obtener token CSRF de múltiples formas (prioritario: form input)
function getCSRFToken() {
    // Método 1: Buscar en input del formulario
    ...
    // Método 3: Buscar en cookie (fallback)
...
// Obtener token CSRF (función antigua - mantener para compatibilidad)
...
async function finishSaleAndGenerateTicket() {
    ...
    try {
        ...
        console.log('DEBUG - CSRF Token length:', token.length);
        console.log('DEBUG - CSRF Token first 20:', token.substring(0, 20));
